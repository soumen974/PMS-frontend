...
export default function TopComp() {
  return (
    ...
    <div className="max-w-screen-xl  items-center justify-between mx-auto  mt-[7rem] mb-5">
        <h1 className='text-center font-bold text-2xl text-gray-600 pb-10'>Top Companies</h1>
        <ul className='flex flex-wrap items-center justify-center gap-[5.2vw] '>
            <li>
                <img className='w-[8vw]' src={Com01} alt="" />
            </li>
            <li>
                <img className='w-[8vw]' src={Com02} alt="" />
            </li>
            <li>
                <img className='w-[8vw]' src={Com03} alt="" />
            </li>
            <li>
                <img className='w-[8vw]' src={Com04} alt="" />
            </li>
