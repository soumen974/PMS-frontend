   ...
   <div className='grid gap-10'>
    <div className='flex gap-2'>
      ...
      <div className='p-10'>
        ...
        <h1 className='text-2xl '>HR name/company</h1>
        <ul className='grid gap-2 '>
          <li  className='text-2xl '>Package</li>
          <li  className='text-2xl '>Location</li>
          <li  className='text-2xl '>Deadline</li>
        </ul>

      </div>
    </div>
    <div>
      <label for="message" className="block mb-2 text-sm font-medium text-gray-900 ">Job discription</label>
