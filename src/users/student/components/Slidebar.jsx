...
const Slidebar = ({slidebarToggle}) => {
  return (
    <div className={`${slidebarToggle? " hidden " : " block "}w-65 bg-pink-900 fixed h-full px-5 py-5 right-0 transition: all 0.5s ease-in-out`}>
      <div className='my-2 mb-4'>
        <div className='flex' >
        <FaBell className='rounded hover:shadow hover:bg-pink-700 inline-block w-6 h-6 text-white font-bold'></FaBell>
        </div>
      </div>
