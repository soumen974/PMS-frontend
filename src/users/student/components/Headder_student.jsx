...
export default function Headder_student() {
  return (
    <>
      <header
        className={`sticky top-0 z-40 flex w-full bg-white drop-shadow-md drop-shadow-gray-100 border-b    `}
      >
            ...
            <form action="" method="">
              <div className="relative">
                <button className=" group absolute top-1/2 left-0 -translate-y-1/2 hover:bg-gray-200 p-2 rounded-full">
                  {/* search icon svg */}
                  <svg
                    className="fill-slate-600 group-hover:fill-blue-400"
                    width="21"
                    height="21"
                    viewBox="0 0 21 21"
