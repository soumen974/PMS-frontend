            ...
            <div className='flex flex-col overflow-y-auto duration-300 ease-linear'>
              ...
              <div>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                    {/* nav links */}
                                <li> <NavLink  to="/Student/home" className={({isActive}) => ` ${ !isActive ? "  hover:bg-opacity-10 hover:bg-gray-100 text-white   " : " bg-green-300 dark:bg-transparent  text-black dark:text-[#FFD575]  hover:text-black  hover:bg-green-200    dark:border dark:border-[#FFD575]  dark:hover:bg-opacity-10 dark:hover:bg-gray-100  "}  group relative flex items-center gap-2.5 rounded-sm py-2 px-14 font-medium  duration-300 ease-in-out  dark:hover:bg-meta-4 `}> Dashboard</NavLink> </li>
                                <li> <NavLink  to="/HR/jobposting" className={({isActive}) => ` ${ !isActive ? "  hover:bg-opacity-10 hover:bg-gray-100 text-white   " : " bg-green-300 dark:bg-transparent  text-black  hover:text-black  hover:bg-green-200    dark:border dark:border-[#FFD575]  dark:hover:bg-opacity-10 dark:hover:bg-gray-100  "} dark:text-[#FFD575]  group relative flex items-center gap-2.5 rounded-sm py-2 px-14 font-medium  duration-300 ease-in-out  dark:hover:bg-meta-4 `}> Jobs</NavLink> </li>
                                <li> <NavLink  to="/HR/Applicants" className={({isActive}) => ` ${ !isActive ? "  hover:bg-opacity-10 hover:bg-gray-100 text-white   " : " bg-green-300 dark:bg-transparent  text-black dark:text-[#FFD575] hover:text-black  hover:bg-green-200    dark:border dark:border-[#FFD575]  dark:hover:bg-opacity-10 dark:hover:bg-gray-100  "} dark:text-[#FFD575]  group relative flex items-center gap-2.5 rounded-sm py-2 px-14 font-medium  duration-300 ease-in-out  dark:hover:bg-meta-4 `}> Applicants</NavLink> </li>
